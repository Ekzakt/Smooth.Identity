        ...
        public static IEnumerable<Client> Clients(IConfiguration configuration) =>
            [
                new Client
                {
                    ...
                    PostLogoutRedirectUris = { configuration["IdentityServer:Clients:0:BaseUri"]! + "/signout-oidc" },
                ...
                new Client
                {
                    ...
                    PostLogoutRedirectUris = { configuration["IdentityServer:Clients:1:BaseUri"]! + "/signout-oidc" },
